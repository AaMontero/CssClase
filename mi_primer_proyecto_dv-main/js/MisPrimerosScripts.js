...
function encenderApagar() {
  var valor = document.getElementById("idImagenFoco").src;
  if (valor.match("../img/focoApagado.png")) {
    valor = "../img/focoEncendido.png";
  } else {
    valor = "../img/focoApagado.png";
  }
  document.getElementById("idImagenFoco").src = valor;
}
